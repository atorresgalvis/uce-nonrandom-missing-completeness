## Title: script to build the graphics of Average Missing Data (i.e. % of missing entries) in species per locus.
...
## Blaimer
	...
	TablaMediaMissLoci <- NULL
	for (i in cortelos ) {
		indexado <- CompValues[CompValues$CompletenessValue >= i,]
		componentes <- indexado$Locus
		subtabla <- MissInfo[,componentes]
		MediaMissLoci <- colMeans(subtabla, na.rm = T)
		tramo <- cbind(rep(i, length(MediaMissLoci)), MediaMissLoci)	
		TablaMediaMissLoci <- rbind(TablaMediaMissLoci, tramo )
	}
	TablaMediaMissLoci <- data.frame(TablaMediaMissLoci)
	colnames(TablaMediaMissLoci) <- c("Cortes", "Miss")
	TablaMediaMissLoci$Cortes <- factor(TablaMediaMissLoci$Cortes)
	
	p1c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		...
		ylab("Average missing entries in species per locus (%)") +
	...
	pdf("AverageMissInSpecies_Blaimer.pdf", width=3.0, height=3.5)
	p1c
	dev.off()
...
## Borowiec
	...
	p2c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Borowiec.pdf", width=3.0, height=3.5)
	p2c
	dev.off()
...
## Buenaventura
	...
	p3c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Buenaventura.pdf", width=3.0, height=3.5)
	p3c
	dev.off()
...
## Cohen
	...
	p4c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Cohen.pdf", width=3.0, height=3.5)
	p4c
	dev.off()
...
## Galleti
	...
	p5c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Galleti.pdf", width=3.0, height=3.5)
	p5c
	dev.off()
...
## Joele
	...
	p6c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Joele.pdf", width=3.0, height=3.5)
	p6c
	dev.off()
...
## Reyes
	...
	p7c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Reyes.pdf", width=3.0, height=3.5)
	p7c
	dev.off()
...
## Santos
	...
	p8c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Santos.pdf", width=3.0, height=3.5)
	p8c
	dev.off()
...
## Zhang
	...
	p9c <- ggplot(TablaMediaMissLoci, aes(x=Cortes, y=Miss)) + 
		stat_boxplot(color = "black", geom = "linerange", width = 0.2, lwd = 1.5) +
		geom_boxplot_jitter(
			outlier.shape = 21,
			outlier.colour = "black",
	...
	pdf("AverageMissInSpecies_Zhang.pdf", width=3.0, height=3.5)
	p9c
	dev.off()	
	
## All datasets	
	pdf("AverageMissInSpeciesAll.pdf", width=12.0, height=10.5)
		grid.arrange(p1c, p2c, p3c, p4c, p5c, p6c, p7c, p8c, p9c, ncol = 3)
	dev.off()	